...
void imageManager::copyAlphaRender(string strKey, HDC hdc, int destX, int destY, image* pImage, BYTE alpha)
{
	image* img = findImage(strKey);
	if (img) img->copyAlphaRender(hdc, destX, destY, pImage, alpha);
}